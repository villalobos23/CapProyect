...
bigramTdm.fplot <-createFrequencyPlot(bigramTdm.freq)
trigramTdm.fplot <- createFrequencyPlot(trigramTdm.freq)
bigramSW.fplot <- createFrequencyPlot(bigramSW.freq,FALSE,minFreq = 12)
trigramSw.fplot <- createFrequencyPlot(trigramSW.freq, useMean = FALSE,2)
